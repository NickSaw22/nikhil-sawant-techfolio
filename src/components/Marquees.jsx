...
" https://assets-global.website-files.com/6334198f239547d0f9cd84b3/65b2ce14e6c85b010c2e1e3c_Logo%20White%201.svg",],
  ...
  return (
    <div className='pt-60 bg-zinc-900 w-full relative overflow-hidden'>{images.map((item,index)=><Marquee direction={index===0?"left":"right"} key={index} imagesurls={item} />)}</div>
  )
}
